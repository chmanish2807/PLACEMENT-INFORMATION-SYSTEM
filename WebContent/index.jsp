...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script></a></li>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li style="margin-left:15px">
            <div class="dropdown">
              <button class="btn  dropdown-toggle" style="outline:none,box-shadow:none" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Profile
              </button>
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <p>Services</p>
          <p>OUR SERVICES EXCEEDS YOURS EXPECTATIONS</p>
        </header>
